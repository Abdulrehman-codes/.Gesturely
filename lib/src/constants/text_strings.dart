...
const String gBoardTitle1="Use Without Touch";
const String gBoardTitle2="Learn from library";
const String gBoardTitle3="Sharing and friends";
const String gBoardSubtitle1="use signs only";
const String gBoardSubtitle2="Open to use";
const String gBoardSubtitle3="jabba jabba";
